...
Crawl the web looking for human-authored blogs.

My blog post when I started this: [Human.json](https://nedbatchelder.com/blog/202603/humanjson).

This started from [Beto Dealmeida's human.json](https://codeberg.org/robida/human.json) idea, but has grown.

Aggregators of blogs:

- [The IndieWeb](https://indieblog.page/)
